...
\pdfcomment{Tady by asi KSI mela zustat, protoze je uvedena i v SISu.}
...
Ústav~výpoèetní~techniky~Univerzity~Karlovy~v~Praze
% dle Organizaèní struktury MFF UK
...
\pdfcomment{Mám sem pøidat nìjaké výsledky, až budou?}
