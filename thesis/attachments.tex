...
\section*{Active Ionospheric Sounding data format}
\lstinputlisting[caption={Active Ionospheric Sounding data format},label=att:format]{listings/AIS_FORMAT.FMT}

%lstinputlisting doesn't work here
\section*{Result file format}
\lstset{language=XML,label=att:result,caption={The XML Schema of the results file}}
\begin{lstlisting}
